    ...
    public class Monitor : IPlugin
    {
        ...
        private Stats GetStats()
        {
            try
            {
                ...
                TimeSpan ts1 = (DateTime.Now - new DateTime(2023, 8, 2, 0, 0, 0, 0));
                TimeSpan ts2 = (new DateTime(2023, 11, 13, 0, 0, 0, 0) - DateTime.Now);
                MonitorSettings.Instance.PassportEnd = "8.2-11.13 已过" +
                    ts1.Days.ToString() + "天" +
